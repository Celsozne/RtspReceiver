...
function avcodec_open2(avctx: PAVCodecContext; const codec: PAVCodec; option: PAVDictionary): Integer; cdecl; external 'avcodec';
...
function avcodec_send_packet(avctx: PAVPacket; const avpkt: PAVPacket): Integer; cdecl; external 'avcodec';
